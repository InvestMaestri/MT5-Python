...
# Made for article on Medium: https://medium.com/@eduardo-bogosian/how-to-pull-data-from-metatrader-5-with-python-4889bd92f62d
# By Eduardo Bogosian - 2022

import pandas as pd
import MetaTrader5 as mt5

# Starts connection with the terminal based on syntax
mt5.initialize()
...
if not trade_allowed_bool:
    print("\nTrades are not allowed.")
elif trade_allowed_bool:
    print("\nTrades permited.")
else:
    print("\nUnkown trade status.")
